<%-- 
    Document   : edit
    Created on : 06/03/2023, 2:35:07 PM
    Author     : Admin
--%>
...
<html>
    ...
    <body>
        <div class="myContainer">
            ...
            <h1 style="text-align: center; padding-top: 25px; color: yellow;">Edit Question</h1>
                <div class="myForm">
                    <div style="padding: 20px;background-color: rgba(242, 176, 198, 0.8);" class="cotent">
                        <form action="edit" method="POST">
                            ...
                            <input style="display: none;" type="text" value="${subject}" name="subject"/>
                        <c:set var="num" value="0"></c:set>
                        Question: <br><input size="50" style="width: 750px; height: 40px;" type="text" name="question" value="${qt.content}" />
                        <br>
                        Answer: <br><c:forEach items="${listA}" var="a">
                            <input style="width: 750px; height: 40px; margin-bottom: 10px" type="text" name="answer" value="${a.content}" />
                            <br>
